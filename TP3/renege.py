...
class RENEGE:
    ...
    def classify_emails(self, is_log_prob = False, is_log_combine = False, clean_option = False):
        '''
    ...
    def process_email(self,new_emails,is_log_prob, is_log_combine, clean_option):
        '''
